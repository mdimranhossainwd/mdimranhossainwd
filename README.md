...
## 💻 Tech Stack :
<img src="https://skillicons.dev/icons?i=javascript,typescript,react,redux,jquery,sass,tailwind,bootstrap,materialui,firebase,nodejs,express,mongodb,supabase,mysql,postgresql,postman,figma,yarn,bun,npm,heroku,vercel,netlify,git,github" />
